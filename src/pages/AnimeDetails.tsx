            ...
            <div className="w-full md:w-1/2 flex flex-col gap-6">
              ...
              <div className="mt-4">
                  <div className="bg-surface-variant rounded-[24px] p-5 border border-surface flex flex-col gap-3">
                    ...
                    <button className="mt-auto py-2 bg-primary text-on-primary rounded-full font-label-md flex justify-center items-center gap-2 hover:opacity-90 active:scale-95 transition-all">
